...
* Performing multiple operations on an object/value fetched via a method/property, while staying [D.R.Y.](https://en.wikipedia.org/wiki/Don't_repeat_yourself) and without needing to create a local var _(while still avoiding invoking the method/getter repeatedly)_.
